...
DEFAULT_DATA = {
    ...
    "commands": [
        {"name": "Restart Shell", "cmd": "omarchy-restart-shell", "desc": "Reload Quickshell desktop environment"},
        {"name": "Git Status", "cmd": "git status", "desc": "Inspect current repository status"},
        {"name": "System Info", "cmd": "fastfetch", "desc": "Show system and hardware overview"}
    ]
}
